...
namespace LinqToObjectAndQueryOperators
{
    class UniversityManager
    {
        ...
        public UniversityManager()
        {
            ...
            students.Add(new Student { Id = 6, Name = "Daniel", Gender = "male", Age = 31, UniversityId = 2 });
        ...
        public void StudenAndUniversityNameCollection()
        {
            var newCollection = from student in students
                                join university in universities
       on student.UniversityId equals university.Id
                                orderby student.Name
                                select new { StudentName = student.Name, UniversityName = university.Name, StudentGender = student.Gender };

            Console.WriteLine("New collection: ");

            foreach (var col in newCollection)
            {
                Console.WriteLine($"Student {col.StudentName} from university {col.UniversityName} is {col.StudentGender}");
            }
